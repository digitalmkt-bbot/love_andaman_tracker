...
'[data-la-logo]{gap:10px !important;justify-content:flex-start !important}',      '[data-la-logo] .la-brand{font-size:15px;font-weight:800;color:#0F1720;line-height:1.15;letter-spacing:-.01em}'
   ...
   function laRestoreView2() {
      ...
      // ปิดตัวจับเวลา — ส่วนนี้ถูกปิดด้วยธง rvDone ตั้งแต่โหลด เดิมจึงเดินเปล่าทุกวินาที
   ...
   function laGoHashDirect() {
      ...
      // ปิดตัวจับเวลา — ส่วนนี้ถูกปิดด้วยธง goDone ตั้งแต่โหลด เดิมจึงเดินเปล่าทุก 0.7 วินาที
      // ส่วนดักเก็บ onClick ของเมนูด้านบนยังจำเป็น เพราะส่วนที่ 41 ใช้อยู่
   ...
   // ===== 46. ผู้ใช้มาก่อนเสมอ =====
      // ตัวกู้หน้าส่วนที่ 41 ทำงานต่อเนื่อง 30 วินาทีหลังโหลด
      // ถ้าระหว่างนั้นผู้ใช้กดเมนูเอง อาจชนกันจนเห็นหน้าแทรก
      // isTrusted คือคลิกจากคนจริง ไม่นับคลิกที่โค้ดสั่ง
...
// ปิดตัวนี้ — เดิมเปิดหน้าที่ 450 มิลลิวินาทีตายตัว ซึ่งเร็วกว่าตอนที่ถึงหน้าที่ถูก
// หน้าภาพรวมจึงโผล่ออกมาก่อน — ตอนนี้ใช้ตัวที่รอจนหน้าถูกต้องจริง (ส่วน 44) แทน
